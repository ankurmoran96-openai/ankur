      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <Sheet>
          <SheetTrigger asChild>
            <Button variant="ghost" size="icon" className="w-10 h-10 md:w-12 md:h-12 hover:bg-white/5 border border-white/5 rounded-full transition-all group">
          ...
          <SheetContent side="right" className="w-full sm:max-w-md bg-card/95 backdrop-blur-3xl border-l border-white/5 p-0 flex flex-col">
            ...
            <div className="p-8 md:p-10 flex-1 flex flex-col justify-center">
               <SheetHeader className="mb-8 md:mb-12 text-left">
                 ...
                 <SheetTitle className="text-4xl md:text-5xl font-display font-bold tracking-tighter uppercase">Menu</SheetTitle>
               ...
               <div className="grid gap-2 md:gap-3">
                 {navLinks.map((link) => (
                   <Link
                     ...
                     href={link.href}
                     className={cn(
                       "group relative flex items-center justify-between p-4 md:p-6 rounded-lg transition-all duration-500 border",
                       pathname === link.href 
                   ...
                   >
                     <div className="flex items-center gap-4 md:gap-6">
                       ...
                       <div>
                         ...
                         <p className="text-[8px] md:text-[10px] font-code tracking-widest uppercase text-muted-foreground">{link.desc}</p>
                       </div>
                     </div>
            ...
            <div className="p-6 md:p-8 border-t border-white/5 bg-black/20 flex justify-between items-center">
               <span className="text-[8px] md:text-[9px] font-code text-muted-foreground tracking-widest">Version 4.0</span>
