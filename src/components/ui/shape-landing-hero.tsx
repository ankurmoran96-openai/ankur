            ...
            >
                <div
                    className={cn(
                        ...
                        "shadow-[0_8px_32px_0_rgba(255,59,59,0.1)]",
                        "after:absolute after:inset-0 after:rounded-full",
                        "after:bg-[radial-gradient(circle_at_50%_50%,rgba(255,59,59,0.2),transparent_70%)]"
                    )}
                />
            </motion.div>
        </motion.div>
...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-[90vh] w-full flex items-center justify-center overflow-hidden bg-[#0E0E12]">
